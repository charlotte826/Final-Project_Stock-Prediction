...
def PlotNaiveBase(screen_name):
    ...
    plt.savefig("confusionfull.png",bbox_inches = "tight")
    report_df.plot(y=['support'], x='label', kind='bar')
    plt.savefig("confusionsupport.png",bbox_inches = "tight")

    sns.heatmap(mat.T,square=True,annot=True,fmt='d',cbar=False,xticklabels=set(labels1),yticklabels=set(labels1))
    plt.xlabel("train data")
    plt.ylabel("predicted data")
    filename="teststock.png"
